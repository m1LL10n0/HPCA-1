...
---
#### Σχόλια:  
- Μερικά μέρη της εκφώνησης δεν εξηγούνται καλά όπως το τι _ακριβώς_ πρέπει να συγκρίνουμε στο ερώτημα 2 β) ή στο σε ποια αρχεία αναφέρεστε στο 2 α) στην πρόταση "Χρησιμοποιήστε **τα αρχεία αυτά**..." καθώς όπως είναι γραμμένη τώρα η πρόταση, επειδή λίγο πρίν λέτε: "Τα αρχεία αυτά παρέχουν..." αναφερόμενοι μόνο στα config.ini και config.json, δίνει την εντύπωση ότι πρέπει να ψάξουμε μόνο στα 2 αυτά αρχεία για όλα τα ερωτήματα.
